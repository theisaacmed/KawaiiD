...
const NPC_DATA = [
  // ===================== TOWN (5 NPCs — starting area) =====================
  {
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(-15, 0, 32) },
      { start: 10, end: 14, pos: new THREE.Vector3(-12, 0, 8) },
      { start: 14, end: 18, pos: new THREE.Vector3(-10, 0, 15) },
    ],
    homePos: new THREE.Vector3(-10, 0, 15),
    district: 'town',
  },
  {
    name: 'Hiro',
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(25, 0, 35) },
      { start: 10, end: 14, pos: new THREE.Vector3(35, 0, 12) },
      { start: 14, end: 18, pos: new THREE.Vector3(25, 0, 30) },
    ],
    homePos: new THREE.Vector3(25, 0, 30),
    district: 'town',
  },
  {
    name: 'Luna',
    position: new THREE.Vector3(5, 0, 22),
    ...
    schedule: [
      { start: 6, end: 17, pos: new THREE.Vector3(5, 0, 22) },
      { start: 17, end: 18, pos: new THREE.Vector3(5, 0, 22) },
    ],
    homePos: new THREE.Vector3(5, 0, 22),
    district: 'town',
  },
  {
    name: 'Ash',
    ...
    schedule: [
      { start: 6, end: 11, pos: new THREE.Vector3(-20, 0, 10) },
      { start: 11, end: 15, pos: new THREE.Vector3(-12, 0, 8) },
      { start: 15, end: 18, pos: new THREE.Vector3(-18, 0, 25) },
    ],
    homePos: new THREE.Vector3(-18, 0, 25),
    district: 'town',
  },
  {
    name: 'Dex',
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(38, 0, 12) },
      { start: 10, end: 14, pos: new THREE.Vector3(30, 0, -10) },
      { start: 14, end: 18, pos: new THREE.Vector3(30, 0, 10) },
    ],
    homePos: new THREE.Vector3(30, 0, 10),
    district: 'town',
  },
  ...
  {
    name: 'Ren',
    position: new THREE.Vector3(-15, 0, 95),
    wants: ['sticker'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(-15, 0, 92) },
      { start: 10, end: 15, pos: new THREE.Vector3(8, 0, 108) },
      { start: 15, end: 18, pos: new THREE.Vector3(-15, 0, 95) },
    ],
    homePos: new THREE.Vector3(-15, 0, 95),
    district: 'downtown',
  },
  {
    name: 'Nao',
    position: new THREE.Vector3(5, 0, 88),
    wants: ['sticker', 'plushie'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 18, pos: new THREE.Vector3(5, 0, 88) },
    ],
    homePos: new THREE.Vector3(5, 0, 88),
    district: 'downtown',
  },
  {
    name: 'Felix',
    position: new THREE.Vector3(38, 0, 112),
    wants: ['gacha', 'plushie'],
    gachaPreference: 'loves',
    personality: 'generous',
    ...
    schedule: [
      { start: 6, end: 14, pos: new THREE.Vector3(38, 0, 112) },
      { start: 14, end: 18, pos: new THREE.Vector3(42, 0, 108) },
    ],
    homePos: new THREE.Vector3(38, 0, 112),
    district: 'downtown',
  },
  {
    name: 'Harper',
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(-25, 0, 110) },
      { start: 12, end: 16, pos: new THREE.Vector3(5, 0, 95) },
      { start: 16, end: 18, pos: new THREE.Vector3(-20, 0, 110) },
    ],
    homePos: new THREE.Vector3(-20, 0, 110),
    district: 'downtown',
  },
  {
    name: 'Marco',
    position: new THREE.Vector3(45, 0, 88),
    wants: ['sticker', 'plushie'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(45, 0, 90) },
      { start: 10, end: 18, pos: new THREE.Vector3(45, 0, 88) },
    ],
    homePos: new THREE.Vector3(45, 0, 88),
    district: 'downtown',
  },
  ...
  {
    name: 'Mika',
    position: new THREE.Vector3(140, 0, -15),
    wants: ['sticker'],
    gachaPreference: 'curious',
    personality: 'generous',
    offerRange: [0.55, 0.70],
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(125, 0, 5) },
      { start: 10, end: 15, pos: new THREE.Vector3(155, 0, -20) },
      { start: 15, end: 18, pos: new THREE.Vector3(140, 0, -15) },
    ],
    homePos: new THREE.Vector3(140, 0, -15),
    district: 'burbs',
  },
  {
    name: 'Zoe',
    position: new THREE.Vector3(158, 0, -20),
    wants: ['gacha'],
    gachaPreference: 'loves',
    personality: 'fair',
    offerRange: [0.65, 0.80],
    ...
    schedule: [
      { start: 15, end: 18, pos: new THREE.Vector3(158, 0, -20) },
    ],
    homePos: new THREE.Vector3(158, 0, -20),
    district: 'burbs',
  },
  {
    name: 'Tomas',
    position: new THREE.Vector3(122, 0, -18),
    ...
    schedule: [
      { start: 6, end: 11, pos: new THREE.Vector3(125, 0, -10) },
      { start: 11, end: 16, pos: new THREE.Vector3(130, 0, 5) },
      { start: 16, end: 18, pos: new THREE.Vector3(122, 0, -18) },
    ],
    homePos: new THREE.Vector3(122, 0, -18),
    district: 'burbs',
  },
  {
    name: 'Sara',
    position: new THREE.Vector3(175, 0, -42),
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(155, 0, -38) },
      { start: 10, end: 15, pos: new THREE.Vector3(125, 0, 5) },
      { start: 15, end: 18, pos: new THREE.Vector3(175, 0, -42) },
    ],
    homePos: new THREE.Vector3(175, 0, -42),
    district: 'burbs',
  },
  ...
  {
    name: 'Jin',
    position: new THREE.Vector3(130, 0, 152),
    wants: ['plushie', 'gacha'],
    gachaPreference: 'curious',
    personality: 'tough',
    offerRange: [0.70, 0.90],
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(118, 0, 135) },
      { start: 10, end: 14, pos: new THREE.Vector3(5, 0, 90) },  // visits Nao's café
      { start: 14, end: 18, pos: new THREE.Vector3(130, 0, 152) },
    ],
    homePos: new THREE.Vector3(130, 0, 152),
    district: 'northtown',
  },
  {
    name: 'Yuna',
    position: new THREE.Vector3(155, 0, 165),
    wants: ['sticker'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(155, 0, 165) },
      { start: 12, end: 13, pos: new THREE.Vector3(155, 0, 170) },
      { start: 13, end: 18, pos: new THREE.Vector3(155, 0, 165) },
    ],
    homePos: new THREE.Vector3(155, 0, 165),
    district: 'northtown',
  },
  {
    name: 'Kai',
    position: new THREE.Vector3(110, 0, 172),
    wants: ['sticker', 'plushie'],
    gachaPreference: 'refuses',
    personality: 'tough',
    offerRange: [0.55, 0.70],
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(110, 0, 175) },
      { start: 12, end: 16, pos: new THREE.Vector3(100, 0, 150) },
      { start: 16, end: 18, pos: new THREE.Vector3(110, 0, 172) },
    ],
    homePos: new THREE.Vector3(110, 0, 172),
    district: 'northtown',
  },
  ...
  // ===================== INDUSTRIAL (3 NPCs — unlocks at 30 deals) =====================
  {
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(-5, 0, -85) },
      { start: 12, end: 15, pos: new THREE.Vector3(-15, 0, -110) },
      { start: 15, end: 18, pos: new THREE.Vector3(-5, 0, -88) },
    ],
    homePos: new THREE.Vector3(-5, 0, -88),
    district: 'industrial',
  },
  {
    name: 'Vex',
    position: new THREE.Vector3(35, 0, -88),
    wants: ['sticker'],
    gachaPreference: 'refuses',
    personality: 'fair',
    offerRange: [0.50, 0.65],
    ...
    schedule: [
      { start: 6, end: 14, pos: new THREE.Vector3(35, 0, -90) },
      { start: 14, end: 18, pos: new THREE.Vector3(55, 0, -108) },
    ],
    homePos: new THREE.Vector3(35, 0, -88),
    district: 'industrial',
  },
  {
    name: 'Polly',
    position: new THREE.Vector3(-5, 0, -112),
    wants: ['plushie'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 11, pos: new THREE.Vector3(-5, 0, -95) },
      { start: 11, end: 13, pos: new THREE.Vector3(-5, 0, -112) },
      { start: 13, end: 18, pos: new THREE.Vector3(-5, 0, -95) },
    ],
    homePos: new THREE.Vector3(-5, 0, -112),
    district: 'industrial',
  },
  ...
  {
    name: 'Sora',
    position: new THREE.Vector3(172, 0, 75),
    wants: ['sticker', 'plushie', 'gacha'],
    gachaPreference: 'loves',
    personality: 'generous',
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(168, 0, 55) },
      { start: 12, end: 16, pos: new THREE.Vector3(158, 0, 78) },
      { start: 16, end: 18, pos: new THREE.Vector3(172, 0, 75) },
    ],
    homePos: new THREE.Vector3(172, 0, 75),
    district: 'uptown',
  },
  {
    name: 'Kenji',
    position: new THREE.Vector3(168, 0, 55),
    wants: ['sticker', 'plushie'],
    gachaPreference: 'refuses',
    personality: 'fair',
    offerRange: [0.80, 0.95],
    ...
    schedule: [
      { start: 6, end: 11, pos: new THREE.Vector3(168, 0, 58) },
      { start: 11, end: 13, pos: new THREE.Vector3(168, 0, 55) },
      { start: 13, end: 18, pos: new THREE.Vector3(168, 0, 58) },
    ],
    homePos: new THREE.Vector3(168, 0, 55),
    district: 'uptown',
  },
  {
    name: 'Mira',
    position: new THREE.Vector3(195, 0, 55),
    wants: ['plushie', 'gacha'],
    gachaPreference: 'loves',
    personality: 'generous',
    offerRange: [0.85, 1.00],
    ...
    schedule: [
      { start: 6, end: 10, pos: new THREE.Vector3(188, 0, 78) },
      { start: 10, end: 15, pos: new THREE.Vector3(195, 0, 58) },
      { start: 15, end: 18, pos: new THREE.Vector3(195, 0, 55) },
    ],
    homePos: new THREE.Vector3(195, 0, 55),
    district: 'uptown',
  },
  ...
  {
    name: 'Quinn',
    position: new THREE.Vector3(-135, 0, 130),
    wants: ['gacha', 'sticker'],
    gachaPreference: 'loves',
    personality: 'fair',
    ...
    homePos: new THREE.Vector3(-135, 0, 130),
    district: 'tower',
  },
  {
    name: 'Dante',
    position: new THREE.Vector3(-152, 0, 100),
    wants: ['plushie', 'sticker'],
    gachaPreference: 'curious',
    personality: 'fair',
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(-155, 0, 102) },
      { start: 12, end: 15, pos: new THREE.Vector3(-140, 0, 140) },
      { start: 15, end: 18, pos: new THREE.Vector3(-152, 0, 100) },
    ],
    homePos: new THREE.Vector3(-152, 0, 100),
    district: 'tower',
  },
  ...
  {
    name: 'Marina',
    position: new THREE.Vector3(-95, 0, 225),
    wants: ['sticker', 'plushie', 'gacha'],
    gachaPreference: 'curious',
    personality: 'fair',
    offerRange: [0.60, 0.75],
    ...
    schedule: [
      { start: 6, end: 12, pos: new THREE.Vector3(-95, 0, 225) },
      { start: 12, end: 13, pos: new THREE.Vector3(-80, 0, 210) },
      { start: 13, end: 18, pos: new THREE.Vector3(-95, 0, 225) },
    ],
    homePos: new THREE.Vector3(-95, 0, 225),
    district: 'port',
  },
  ...
  // ===================== ACE HQ (1 NPC — endgame unlock) =====================
  {
    ...
    homePos: new THREE.Vector3(-125, 0, -50),
    district: 'aceHQ',
  },
];
